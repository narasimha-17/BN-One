  ...
  fullstack: [
    {
      ...
      url: 'fs-legal',
      buyUrl: 'https://agentosys.gumroad.com/l/fs-legal',
    },
    {
      ...
      url: 'fs-medical',
      buyUrl: 'https://agentosys.gumroad.com/l/fs-medical',
    },
    {
      ...
      url: 'fs-supply',
      buyUrl: 'https://agentosys.gumroad.com/l/fs-supply',
    },
  ],
  aiml: [
    {
      ...
      url: 'ai-agro',
      buyUrl: 'https://agentosys.gumroad.com/l/ai-agro',
    },
    {
      ...
      url: 'ai-brain',
      buyUrl: 'https://agentosys.gumroad.com/l/ai-brain',
    },
  ],
  datascience: [
    {
      ...
      url: 'ds-water',
      buyUrl: 'https://agentosys.gumroad.com/l/ds-water',
    },
  ],
  cybersecurity: [
    {
      ...
      url: 'sec-token',
      buyUrl: 'https://agentosys.gumroad.com/l/sec-token',
    },
  ],
  iot: [
    {
      ...
      url: 'iot-mesh',
      buyUrl: 'https://agentosys.gumroad.com/l/iot-mesh',
    },
  ],
  cbasics: [
    {
      ...
      url: 'c-library-mgmt',
      buyUrl: 'https://agentosys.gumroad.com/l/c-library-mgmt',
    },
    {
      ...
      buyUrl: 'https://agentosys.gumroad.com/l/cpp-student-records',
    },
    {
      ...
      url: 'c-bank-mgmt',
      buyUrl: 'https://agentosys.gumroad.com/l/c-bank-mgmt',
    },
    {
      ...
      url: 'cpp-snake-game',
      buyUrl: 'https://agentosys.gumroad.com/l/cpp-snake-game',
    },
  ],
}
...
for (let i = 2; i <= 6; i++) {
  ...
  collegeDatabase.datascience.push({
    ...
    url: dsUrl,
    buyUrl: `https://agentosys.gumroad.com/l/${dsUrl}`,
  })
  ...
  collegeDatabase.cybersecurity.push({
    ...
    url: secUrl,
    buyUrl: `https://agentosys.gumroad.com/l/${secUrl}`,
  })
  ...
  collegeDatabase.iot.push({
    ...
    url: iotUrl,
    buyUrl: `https://agentosys.gumroad.com/l/${iotUrl}`,
  })
}
